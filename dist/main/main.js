...
/******/ 	var hotCurrentHash = "0d0885a685a351208d15"; // eslint-disable-line no-unused-vars
...
eval("const { app, BrowserWindow } = __webpack_require__(\"electron\");\nconst path = __webpack_require__(\"path\");\nconst url = __webpack_require__(\"url\");\n\nconst isDevelopment = process.env.NODE_ENV !== 'production';\n\nlet win;\n\nfunction createWindow() {\n    win = new BrowserWindow({\n        width: 800,\n        height: 600\n    });\n\n    if (isDevelopment) {\n        win.loadURL(`http://localhost:${process.env.ELECTRON_WEBPACK_WDS_PORT}`);\n        win.webContents.openDevTools();\n    } else {\n        win.loadURL(url.format({\n            pathname: path.resolve('index.html'),\n            protocol: 'file:',\n            slashes: true\n        }));\n    }\n\n    win.on('closed', () => {\n        win = null;\n    });\n}\n\napp.on('ready', createWindow);\n\napp.on('window-all-closed', () => {\n    if (process.platform !== 'darwin') {\n        app.quit();\n    }\n});\n\napp.on('activate', () => {\n    if (win === null) {\n        createWindow();\n    }\n});//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./src/main/index.js\n");
...
eval("module.exports = require(\"url\");//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///url\n");
